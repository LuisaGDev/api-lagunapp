...
var userCtrl        = Cobuild.Utils.Files.getController('users.userController');
var authPolicyIsLoggedIn      = Cobuild.Policies.getPolicy(config.authentication.strategy+'.isLoggedIn');
